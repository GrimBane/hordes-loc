export default [
  {
    ...
    description: {
      ...
      fr: 'Des ingrédients brûlés ont été tordus et liés ensemble pour former une amulette de maigre protection. La création d\'amulettes simples comme celle-ci a été une tactique de survie courante depuis l\'antiquité.',
...

  {
    ...
    description: {
      ...
      es: 'Los collares para mantener a los lobos en servidumbre están hechos de cuero grueso. Algunos de ellos todavía tienen cadenas de eslabones atados, pero todos los collares de lobo son robustos. Algunos collares están imbuidos con protección espiritual.',
      pt: 'Colares para manter os lobos em servidão são feitos de um couro grosso. Alguns deles ainda têm elos de cadeia conectados, mas todos os colares de lobos são robustos. Alguns colares estão imbuídos de proteção espiritual.',
      nl: 'Halsbanden om wolven in slavernij te houden zijn gemaakt van een dik leer. Sommige hebben nog steeds kettingschakels, maar alle wolvenhalsbanden zijn stevig. Sommige kragen zijn doordrenkt met spirituele bescherming.',
...

  {
    ...
    description: {
      ...
      fr: 'Ce collier est composé de fragments d\'os provenants d\'une variété de créatures fortes. La protection de chaque collier d\'os varie en fonction de l\'origine des os.',
...

  {
    ...
    description: {
      ...
      fr: 'Des griffes de redoutables loups-garous, laissées sur le corps des victimes, étaient ointes d\'huiles mystiques et imprégnées d\'une force spirituelle par la méditation. Les créateurs de ces amulettes espéraient que ces protections spirituelles seraient un jour utilisées dans le but de se venger.',
...

  {
    ...
    description: {
      ...
      fr: 'Lorsqu\'une griffe a été trouvée, elle était considérée comme un présent de la part des oiseaux sacrés des montagnes. Les moines dans les montagnes utilisaient les serres pour produire des amulettes spirituelles afin de se protéger des envahisseurs lors des combats.',
...

  {
    ...
    description: {
      ...
      es: 'Los antiguos pobladores del desierto recolectaban piedras especiales y las moldeaban en escarabajos a través de una magia extraña y oscura. Muchas personas importantes en esa antigua civilización usaban estos amuletos como un símbolo de estatus y para protección.',
...

  {
    ...
    description: {
      ...
      es: 'Extraños fragmentos minados de las montañas fueron enriquecidos por místicos y posteriormente fueron formados en amuletos con el fin de proporcionar protección y causar miedo.',
...

  {
    ...
    description: {
      ...
      es: 'Las teocracias de guerra crearon símbolos omega divinos como medio de protección. Estos símbolos se usaban para disuadir los ataques, también se daban como regalos de protección y se los regalaba a los posibles seguidores religiosos.',
      pt: 'As teocracias beligerantes criaram símbolos ómega divinos como meio de protecção. Estes símbolos foram usados para dissuadir ataques, dados como presentes protetores, e apresentados a potenciais seguidores religiosos.',
...

  {
    ...
    description: {
      ...
      es: 'Este amuleto tiene un extraño conjunto de discos superpuestos que absorben energía natural y amplifican la protección natural del usuario. Muchos usuarios de magia se esfuerzan por aprender los secretos de estos amuletos para que puedan ser reproducidos.',
      pt: 'Este amuleto tem um estranho conjunto de discos sobrepostos que aproveitam as energias naturais e amplificam a protecção natural do utilizador. Muitos usuários de magia esforçam-se para aprender os segredos destes amuletos para que eles possam ser reproduzidos.',
...

  {
    ...
    description: {
      ...
      pt: 'Os reis antigos tinham símbolos ankh poderosos feitos para os proteger na vida após a morte. Ladrões de sepulturas roubaram muitos desses amuletos e os venderam para ambas as pessoas e monstros. Cada ankh tem um brilho estranho que desmente o seu verdadeiro poder.',
...

  {
    ...
    description: {
      ...
      pt: 'Peças torcidas da enorme World Tree, Yggdrasil, foram transformadas em amuletos do tipo mais sagrado. A seiva escorre do amuleto e é absorvida pelo corpo para proteção extra.',
...

  {
    ...
    description: {
      ...
      es: 'Este amuleto contiene una gema de la corona usada por un famoso rey. Los bordes de este amuleto son despiadadamente afilados y están parcialmente embadurnados con una sustancia misteriosa.',
